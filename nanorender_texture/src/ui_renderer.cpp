...
#include <string.h>
#include <algorithm>
// Part 4 visual-only UI transformation.
// The UI is drawn with an offset, but MicroUI input hitboxes remain unchanged.
static const int UI_VISUAL_OFFSET_X = 80;
static const int UI_VISUAL_OFFSET_Y = 40;
...
void UIRenderer::draw_text(const char* text, mu_Vec2 pos, mu_Color color) {
    uint32_t c = to_uint32(color);
    int x = pos.x + UI_VISUAL_OFFSET_X;
    int y = pos.y + UI_VISUAL_OFFSET_Y;
